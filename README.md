...
- **Kind 15** -- Mail message (unsigned rumor, gift-wrapped)
- **Kind 16** -- Mail receipt (delivery/read confirmation, gift-wrapped)
...
| File | Contents |
|------|----------|
| `mail-event.json` | Kind 15 rumor creation (7 vectors) |
